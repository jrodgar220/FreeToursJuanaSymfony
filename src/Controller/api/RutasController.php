...
{ 
    ...
    public function formRuta( ): Response
    {
        return $this->render('rutas/index.html.twig');
    }

    #[Route('/listado', name:'vista_lista_ruta')]
    public function indexRuta(RutaRepository $rutaRepository): Response
    {
    ...
    public function listarRutas(SerializerInterface $serializer,RutaRepository $rutaRepository): Response
    {
        $listaRutas = $rutaRepository->findAll();
        $rutasSerializadas=[];
